...
#define BUF 200
#define NUM 60
#define MEDIA_SITE 128 
#define MEDIA_PATCH 5
...
//void ina_data(FILE *, FILE *, FILE *, double time);
void ina_data(FILE *, FILE *, double time);
//void ina_data(FILE *, double time);
//void na_active_data(FILE *, FILE *, FILE *, double time);
